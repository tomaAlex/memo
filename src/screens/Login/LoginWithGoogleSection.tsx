...
const LoginWithGoogleSection = ({ setAwaitingLoginStatus }: TProps) => {
	...
	return (
		...
		>
			...
			<View style={styles.container__body__signinButton__captionContainer}>
				<Text style={styles.container__body__signinButton__captionContainer__caption}>{t("googleLoginButton")}</Text>
			</View>
		</TouchableOpacity>
	);
};

export default React.memo(LoginWithGoogleSection);
